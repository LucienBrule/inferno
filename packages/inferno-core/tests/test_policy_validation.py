...
from inferno_core.validation.cabling import validate_policy_sanity, Finding
...
class TestPolicyValidationIntegration:
    ...
    def test_policy_validation_in_main_flow(self):
        ...
        from inferno_core.validation.cabling import run_cabling_validation, validate_policy_sanity
