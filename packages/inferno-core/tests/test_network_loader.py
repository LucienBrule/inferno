...
from inferno_core.data.network_loader import (
    ...
    TopologyRec, TorRec, SpineRec, NodeRec, SiteRec, NicRec
)
...
"""
        ...
        with pytest.raises(ValueError, match="Expected dict structure"):
            load_tors(tors_file)
...
"""
        ...
        with pytest.raises(ValueError, match="Expected list structure"):
