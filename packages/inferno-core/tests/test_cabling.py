...
class TestCableTypeSelection:
    ...
    def test_25g_dac_selection(self):
        ...
        cable_type, length_bin = _select_cable_type_and_bin(
            2.0, '25G', self.policy, self.length_bins
        )
    ...
    def test_25g_aoc_selection(self):
        ...
        cable_type, length_bin = _select_cable_type_and_bin(
            5.0, '25G', self.policy, self.length_bins
        )
    ...
    def test_25g_fiber_selection(self):
        ...
        cable_type, length_bin = _select_cable_type_and_bin(
            15.0, '25G', self.policy, self.length_bins
        )
    ...
    def test_100g_dac_selection(self):
        ...
        cable_type, length_bin = _select_cable_type_and_bin(
            1.5, '100G', self.policy, self.length_bins
        )
    ...
    def test_rj45_selection(self):
        ...
        cable_type, length_bin = _select_cable_type_and_bin(
            3.0, 'RJ45', self.policy, self.length_bins
        )
    ...
    def test_unknown_link_type(self):
        ...
        cable_type, length_bin = _select_cable_type_and_bin(
            2.0, 'UNKNOWN', self.policy, self.length_bins
        )
...
class TestBOMAggregation:
    ...
    def test_aggregate_single_cable_type(self):
        ...
        expected = {
            'QSFP28 100G DAC': {
                1: 3,  # 2 * 1.1 = 2.2, rounds up to 3
                2: 2   # 1 * 1.1 = 1.1, rounds up to 2
            }
        }
        assert bom == expected
...
class TestExportFunctions:
    ...
    def test_export_yaml(self, tmp_path):
        ...
        bom = {
            'QSFP28 100G DAC': {1: 2, 2: 3},
            'RJ45 Cat6A': {3: 1}
        }
        warnings = ['Test warning']
        policy = {
            'version': 'test',
            'defaults': {'spares_fraction': 0.10, 'slack_factor': 1.2}
        }
