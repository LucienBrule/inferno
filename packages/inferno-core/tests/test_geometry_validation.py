...
from inferno_core.validation.cabling import validate_lengths, _load_policy
...
class TestGeometryValidation:
    ...
    def test_slack_variants_consistency(self, fixtures_path):
        ...
        topology_1_0, tors_1_0, nodes_1_0, site_1_0, policy_1_0 = self._load_fixture_data("slack_variants/slack_1_0", fixtures_path)
        topology_1_5, tors_1_5, nodes_1_5, site_1_5, policy_1_5 = self._load_fixture_data("slack_variants/slack_1_5", fixtures_path)
